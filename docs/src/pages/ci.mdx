...
Add the following as a **secret** in the settings of your repo, under **Secrets and variables > Actions**:
...
- Select the desired workflow (e.g., `spring-boot.yml`, `svelte-kit.yml`, or `docs.yml`).
