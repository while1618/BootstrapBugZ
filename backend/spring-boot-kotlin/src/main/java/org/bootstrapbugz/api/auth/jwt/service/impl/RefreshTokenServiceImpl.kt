...
class RefreshTokenServiceImpl(
    ...
    override fun create(userId: Long?, roleDTOs: Set<RoleDTO>, ipAddress: String): String {
        ...
        refreshTokenStoreRepository.save(RefreshTokenStore(token, userId, ipAddress, tokenDuration.toLong()))
        return token
    }
    ...
    override fun deleteByUserIdAndIpAddress(userId: Long?, ipAddress: String) {
        refreshTokenStoreRepository
            .findByUserIdAndIpAddress(userId, ipAddress)
            .ifPresent { entity: RefreshTokenStore -> refreshTokenStoreRepository.delete(entity) }
    }
