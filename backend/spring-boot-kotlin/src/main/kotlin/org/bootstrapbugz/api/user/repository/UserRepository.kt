...
interface UserRepository : JpaRepository<User, Long> {
  @EntityGraph(attributePaths = ["roles"]) override fun findAll(pageable: Pageable): Page<User>

  @EntityGraph(attributePaths = ["roles"]) fun findWithRolesById(id: Long): Optional<User>
