...
data class PatchUserRequest(
  ...
  val lastName: String?,
  @field:Pattern(regexp = Regex.USERNAME, message = "{username.invalid}") val username: String?,
  @field:Email(message = "{email.invalid}", regexp = Regex.EMAIL) val email: String?,
  @field:Pattern(regexp = Regex.PASSWORD, message = "{password.invalid}") val password: String?,
