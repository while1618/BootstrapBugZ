...
data class UserRequest(
  ...
  @NotNull(message = "{user.active.required}") val active: Boolean,
  @NotNull(message = "{user.lock.required}") val lock: Boolean,
  @NotEmpty(message = "{roles.empty}") val roleNames: MutableSet<RoleName>
)
